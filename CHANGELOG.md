...
- **deps**: bump pillow to >=12.3.0

## v1.2.3 (2026-04-17)

### Fix

- **camera**: skip v4l2loopback for capture and add --camera

## v1.2.2 (2026-04-12)

### Fix

- **cli**: Typer option defaults and clean version exit

### Perf

- **overlay**: precompute RGB cache, hoist mask; avoid detection copy
